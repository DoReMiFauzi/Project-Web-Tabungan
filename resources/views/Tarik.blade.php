...
<head>
    ...
    <link rel="stylesheet" href="/css/tarik.css">
...
<!-- SideBar -->
    <div class="sidebar">
      ...
      <ul class="menu">
        ...
        <li  class="active"><a href="{{ route('Tabungan.viewTarik') }}">Tarik Uang</a></li>
    ...
    <div class="main-content">
        ...
        <form action="{{ route('Tabungan.tarik') }}" method="post" autocomplete="off">
            @csrf
